...
{
    public partial class HoaDonList : Window
    {
        ...
        public HoaDonList()
        {
            ...
            this.PreviewKeyDown += HoaDonList_PreviewKeyDown;
            ...
            // 1. Gán Source ngay
            _viewSource.Source = AppProviders.HoaDons.Items;
            _viewSource.Filter += ViewSource_Filter;
            HoaDonDataGrid.ItemsSource = _viewSource.View;

            // 2. Subscribe OnChanged (sau khi Source đã có)
            AppProviders.HoaDons.OnChanged += () => ApplySearch();
        ...
        private void ApplySearch()
        {
            ...
            _viewSource.View.SortDescriptions.Add(new SortDescription(nameof(HoaDonDto.LastModified), ListSortDirection.Descending));

            var view = _viewSource.View.Cast<HoaDonDto>().ToList();
        ...
        {
            if (e.Item is not HoaDonDto item)
            {
                e.Accepted = false;
                return;
            }
        ...
        private void HoaDonList_PreviewKeyDown(object sender, KeyEventArgs e)
        {
