...
public class HoaDonImporter
{
    ...
    public async Task ImportTodayAsync()
    {
        ...
        var hoadons = (await oldDb.QueryAsync<OldHoaDon>(@"
            ...
            WHERE h.IdNhomHoaDon < 10 and h.NgayHoaDon >= @today
            ORDER BY h.IdHoaDon
    ...
    (Id, HoaDonId, PhuongThucThanhToanId, SoTien, Ngay, NgayGio, CreatedAt, LastModified, KhachHangId)
    VALUES (@Id, @HoaDonId, @PTTT, @SoTien, @Ngay, @NgayGio, @CreatedAt, @LastModified, @KhId)
", new
                    {
                        Id = Guid.NewGuid(),
                        HoaDonId = hoaDonId,
...
", new
    ...
    (Id, HoaDonId, KhachHangId, SoTienNo, SoTienDaTra, Ngay, NgayGio, CreatedAt, LastModified)
    VALUES (@Id, @HoaDonId, @KhId, @SoTienNo, 0, @Ngay, @NgayGio, @CreatedAt, @LastModified)
", new
                    {
                        Id = Guid.NewGuid(),
                        HoaDonId = hoaDonId,
