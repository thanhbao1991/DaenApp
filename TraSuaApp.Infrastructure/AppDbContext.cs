...
public partial class AppDbContext : DbContext, IAppDbContext
{
    ...
    // ✅ Bắt buộc để implement IAppDbContext
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ChiTietHoaDonEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_ChiTietHoaDons_IsDeleted_LastModified")
            ...
            entity.HasOne(d => d.SanPhamBienThe)
                  .WithMany(p => p.ChiTietHoaDons)
                  .HasForeignKey(d => d.SanPhamBienTheId)
                  .OnDelete(DeleteBehavior.Restrict);
        });

        // ======================
        // ChiTietHoaDonNhapEntity
        // ======================
        modelBuilder.Entity<ChiTietHoaDonNhapEntity>(entity =>
        {
            entity.HasIndex(e => e.HoaDonNhapId, "IX_ChiTietHoaDonNhaps_HoaDonNhapId");
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_ChiTietHoaDonNhaps_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        modelBuilder.Entity<ChiTietHoaDonNo>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_NoHoaDons_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        modelBuilder.Entity<ChiTietHoaDonThanhToan>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_ThanhToans_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.HoaDon)
                  .WithMany(p => p.ChiTietHoaDonThanhToans)
                  .HasForeignKey(d => d.HoaDonId)
                  .HasConstraintName("FK_Payments_HoaDons_HoaDonId")
                  .OnDelete(DeleteBehavior.Restrict);

            entity.HasOne(d => d.PhuongThucThanhToan)
                  .WithMany(p => p.ChiTietHoaDonThanhToans)
        ...
        modelBuilder.Entity<ChiTietHoaDonTopping>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_ChiTietHoaDonToppings_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.HoaDon)
                  .WithMany(p => p.ChiTietHoaDonToppings)
                  .HasForeignKey(d => d.HoaDonId)
                  .OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<ChiTietHoaDonVoucher>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_VoucherLogs_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.HoaDon)
                  .WithMany(p => p.ChiTietHoaDonVouchers)
                  .HasForeignKey(d => d.HoaDonId)
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_ChiTietTuyChinhMons_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.HasIndex(e => e.TuyChinhMonId, "IX_ChiTietTuyChinhMons_TuyChinhMonId");

            entity.Property(e => e.Id).ValueGeneratedNever();

            entity.HasOne(d => d.TuyChinhMon)
                  .WithMany(p => p.ChiTietTuyChinhMons)
                  .HasForeignKey(d => d.TuyChinhMonId)
                  .OnDelete(DeleteBehavior.Restrict);
        });
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_CongThucs_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_CongViecNoiBos_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.Property(e => e.Id).ValueGeneratedNever();
        });
        ...
        modelBuilder.Entity<ChiTietHoaDonPoint>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_ChiTietHoaDonPoints_IsDeleted_LastModified")
                  .IsDescending(false, true);

            entity.Property(e => e.Id).ValueGeneratedNever();

            entity.HasOne(d => d.KhachHang)
                  .WithMany(p => p.ChiTietHoaDonPoints)
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_HoaDons_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_HoaDonNhaps_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.Property(e => e.Id).ValueGeneratedNever();
        });
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_KhachHangs_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.Property(e => e.Id).ValueGeneratedNever();
        });
        ...
        modelBuilder.Entity<KhachHangAddress>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.KhachHangId, e.DiaChi }, "IX_KhachHangAddresses_IdKhachHang_TenDiaChi")
                  .IsUnique();
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_KhachHangAddresses_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.KhachHang)
                  .WithMany(p => p.KhachHangAddresses)
                  .HasForeignKey(d => d.KhachHangId)
        ...
        modelBuilder.Entity<KhachHangPhone>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.KhachHangId, e.SoDienThoai }, "IX_KhachHangPhones_IdKhachHang_SoDienThoai")
                  .IsUnique();
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_KhachHangPhones_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_LichSuNhapXuatKhos_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.NguyenLieu)
                  .WithMany(p => p.LichSuNhapXuatKhos)
                  .HasForeignKey(d => d.NguyenLieuId)
                  .OnDelete(DeleteBehavior.Restrict);
        });
        ...
        modelBuilder.Entity<Log>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_Logs_IsDeleted_LastModified")
                  .IsDescending(false, true);

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Ip).HasMaxLength(100).HasColumnName("IP");
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_NguyenLieus_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.Property(e => e.Id).ValueGeneratedNever();
        ...
        modelBuilder.Entity<NhomSanPham>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_NhomSanPhams_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        modelBuilder.Entity<PhuongThucThanhToan>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_PhuongThucThanhToans_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        modelBuilder.Entity<SanPham>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_SanPhams_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.NhomSanPham)
                  .WithMany(p => p.SanPhams)
                  .HasForeignKey(d => d.NhomSanPhamId)
                  // ⛔ Không cho xoá nhóm khi còn sản phẩm:
                  .OnDelete(DeleteBehavior.Restrict)
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_SanPhamBienThes_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        modelBuilder.Entity<SuDungNguyenLieu>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_SuDungNguyenLieus_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasOne(d => d.CongThuc)
                  .WithMany(p => p.SuDungNguyenLieus)
        ...
        modelBuilder.Entity<TaiKhoan>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_TaiKhoans_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        // ======================
        // Topping (+ link table với NhomSanPham)
        // ======================
        modelBuilder.Entity<Topping>(entity =>
        {
            entity.HasIndex(e => e.Ten, "IX_Topping_Ten").IsUnique();
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_Toppings_IsDeleted_LastModified")
                  .IsDescending(false, true);
            ...
            entity.HasMany(d => d.NhomSanPhams)
                  .WithMany(p => p.Toppings)
                  .UsingEntity<Dictionary<string, object>>(
                    "ToppingNhomSanPhamLink",
                    r => r.HasOne<NhomSanPham>()
                          .WithMany()
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_TuyChinhMons_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.Property(e => e.Id).ValueGeneratedNever();
        });
        ...
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_Vouchers_IsDeleted_LastModified")
                  .IsDescending(false, true);
        ...
        // ======================
        // KhachHangGiaBan (bổ sung mapping + Restrict)
        // ======================
        modelBuilder.Entity<KhachHangGiaBan>(entity =>
        {
            entity.HasIndex(e => new { e.IsDeleted, e.LastModified }, "IX_KhachHangGiaBans_IsDeleted_LastModified")
                  .IsDescending(false, true);
            entity.HasIndex(e => new { e.KhachHangId, e.SanPhamBienTheId }, "IX_KhachHangGiaBans_KH_SanPhamBienThe")
                  .IsUnique();
