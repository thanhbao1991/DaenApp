...
namespace TraSuaApp.Infrastructure.Migrations
{
    ...
    [Migration("20250710095615_RenameIdKhachHangToIdOld")]
    partial class RenameIdKhachHangToIdOld
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TraSuaApp.Domain.Entities.KhachHangAddress", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdOld" }, "IX_ShippingAddress_Default")
                        .IsUnique()
            ...
            modelBuilder.Entity("TraSuaApp.Domain.Entities.KhachHangPhone", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdOld" }, "IX_CustomerPhoneNumber_Default")
                        .IsUnique()
                        .HasFilter("([IsDefault]=(1))");
